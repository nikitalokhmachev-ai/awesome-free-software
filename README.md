...
- [Greywall](https://github.com/GreyhavenHQ/greywall) - Deny-by-default command sandbox for AI coding agents and CLI tools, with filesystem and network isolation, built-in profiles for agents like Claude Code or OpenCode, and learning mode. ([Apache License 2.0](https://github.com/GreyhavenHQ/greywall/blob/main/LICENSE))
